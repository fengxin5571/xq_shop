...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th style="width:450px"><a href="javascript:listTable.sort('goods_name'); "><?php echo $this->_var['lang']['goods_name']; ?></a><?php echo $this->_var['sort_goods_name']; ?></th>
    <th><a href="javascript:listTable.sort('goods_sn'); "><?php echo $this->_var['lang']['goods_sn']; ?></a><?php echo $this->_var['sort_goods_sn']; ?></th>
    <th style="width:100px"><a href="javascript:listTable.sort('goods_sn'); ">商品型号</a><?php echo $this->_var['sort_goods_sn']; ?></th>        <th><a href="javascript:listTable.sort('shop_price'); "><?php echo $this->_var['lang']['shop_price']; ?></a><?php echo $this->_var['sort_shop_price']; ?></th>
...
?>
  <tr>
    ...
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><?php if ($this->_var['goods']['is_presell']): ?><span style="color:blue">【预售商品】</span><?php endif; ?><span onclick="listTable.edit(this, 'edit_goods_name', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span></td>
