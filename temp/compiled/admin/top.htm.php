...
*margin-top:-18px;
	...
	border-right: 1px solid #27AAE7;
    border-left: 1px solid #0779BA;
}
#menu-div ul li a {
	float: LEFT;
	color: #FFF;
...
.num {
	width: 32px;
	height: 16px;
	background: url(images/menu/index-11_22.png) no-repeat scroll;
	display: inline-block;
	line-height: 16px;
	vertical-align: middle;
	text-align: center;
...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="images/logo.gif" alt="ECSHOP - power for e-commerce" width="130" height="50"/></div>
  <div id="submenu-div">
    <ul>
    
    <li><a href="privilege.php?act=logout" target="_top" class="fix-submenu"><img src="images/menu/topmune_08.png" style="border:none;"><span><?php echo $this->_var['lang']['signout']; ?></span></a></li>
    <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/menu/qingchu.png" style="border:none;"><span><?php echo $this->_var['lang']['clear_cache']; ?></span></a></li>
    <li><a href="message.php?act=list" target="main-frame"><img src="images/menu/topmune_05.png" style="border:none;"><span><?php echo $this->_var['lang']['view_message']; ?></span></a></li>	  
    <li><a href="#"  onclick="ShowToDoList()"><img src="images/menu/topmune_02.png" style="border:none;"><span><?php echo $this->_var['lang']['todolist']; ?></span></a></li>
    <li><a href="../" target="_blank"><img src="images/menu/topmune_06.png" style="border:none;"/><span><?php echo $this->_var['lang']['preview']; ?></span></a></li>  
      <li></li>
...
<div id="menu-div">
  <ul>
    ...
    <li style="border-left:none;"><a href="index.php?act=main" target="main-frame"><img src="images/menu/index-11_07.png" width="17" height="18" style="border:none;" align="absmiddle"/><span><?php echo $this->_var['lang']['admin_home']; ?></span></a><span class="muneFG"></span></li>
    
    <li><a href="privilege.php?act=modif" target="main-frame"><img src="images/menu/index-11_41.png" width="17" height="18" align="absmiddle"/><span><?php echo $this->_var['lang']['set_navigator']; ?></span></a><span class="muneFG"></span></li>
    <li><a href="goods.php?act=list" target="main-frame"><img src="images/menu/index-11_09.png" width="17" height="18" align="absmiddle"/><span>商品管理</span><span class="num"><?php echo $this->_var['goods_sum']; ?></span></a><span class="muneFG"></span></li>
     <li><a href="order.php?act=list" target="main-frame"><img src="images/menu/dd.png" width="15" height="18" align="absmiddle"/><span>订单管理</span><span class="num"><?php echo $this->_var['order_sum']; ?></span></a><span class="muneFG"></span></li>
     <li><a href="ads.php?act=list" target="main-frame"><img src="images/menu/index-11_13.png" width="17" height="20" align="absmiddle"/><span>广告管理</span><span class="num"><?php echo $this->_var['ad_sum']; ?></span></a><span class="muneFG"></span></li>
     <li><a href="comment_manage.php?act=list" target="main-frame"><img src="images/menu/index-11_19.png" width="17" height="18" align="absmiddle"/><span>用户评论</span><span class="num"><?php echo $this->_var['comment_sum']; ?></span></a><span class="muneFG"></span></li>
