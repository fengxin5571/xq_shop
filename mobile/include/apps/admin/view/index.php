...
<title>{$lang['cp_home']} - Powered by XQ_Touch</title>
...
<body>
<div id="admin_header">
  <div id="admin_logo"><img src="__ASSETS__/images/topLogo.jpg" height='45'/></div>
  <div id="submenu-div">
    <ul>
...
<div id="admin_bottom" style="text-align:center; line-height:30px">Copyright &copy; <?php echo date('Y');?> 天下无限（北京）科技有限公司. All Rights Reserved.</div>
