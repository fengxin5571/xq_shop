      ...
      <ul>
        ...
        <li>
          <div class="input-text code"><b><?php echo $this->_var['lang']['code']; ?>：</b><span>
            ...
            <input class="pull-right ect-bg" id="zphone" name="sendsms" onclick="sendSms();" type="botton" value="<?php echo $this->_var['lang']['get_code']; ?>" style="width: 110px;height: 46px;border: none;text-align: center;">
            </div>
        </li>
      </ul>
  </section>
