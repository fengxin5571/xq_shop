...
<form action="<?php echo url('user/edit_address');?>" method="post" name="theForm" onsubmit="return checkConsignee(this)">
    ...
    <ul>
      <li>
        <div class="input-text"><b class="pull-left"><?php echo $this->_var['lang']['consignee_name']; ?>：</b><span>
          <input name="consignee" placeholder="<?php echo $this->_var['lang']['consignee_name']; ?><?php echo $this->_var['lang']['require_field']; ?>" type="text" class="inputBg" value="<?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?>" />
          </span></div>
      </li>
      <li>
...
?>
  ...
  <div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"> <a class="btn btn-info ect-colorf" href="<?php echo url('user/del_address_list', array('id'=>$this->_var['consignee']['address_id']));?>" ><?php echo $this->_var['lang']['drop']; ?></a>
    <button type="submit" name="submit"  class="btn btn-info ect-bg-colory"><?php echo $this->_var['lang']['confirm_edit']; ?></button>
