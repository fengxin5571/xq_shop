...
class wx_new_qrcode
{
	...
	function get_code($order, $payment)
	{
        ...
        if($unifiedOrderResult["code_url"] != NULL)
        {
            ...
            $html = '<div class="wx_qrcode" style="position: relative;width: 672px;margin: 0 auto;">';
            $html .= '<div class="p-w-hd">微信支付</div>';
            $html .= '<div class="p-w-bd">';
            $html .= "<div style=\"position: absolute;top: -1px;left: 130px;\">支付后点击<a href=\"user.php?act=order_list\" style='color: #0374D9;'>此处</a>查看我的订单</div>";
            $html .= '<div class="p-w-box">';
            $html .= '<div class="pw-box-hd">';
            $html .= $this->getcode($code_url);
            $html .= "</div>";
            $html .= '<div class="pw-box-ft"><img src="themes/default/images/robot/wx_ft.png" width="187"/></div>';
            $html .= "</div>";
            $html .= '<div class="p-w-sidebar"></div>';
            $html .= "</div>";
            $html .= "</div>";
