...
//        }
        ...
        $button = '<div style="text-align:center"><input type="button" data-reveal-id="myModal" onclick="window.open(\'https://www.alipay.com/cooperate/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="" class="alipay_anniu" title="' .$GLOBALS['_LANG']['pay_button']. '"/></div>';
