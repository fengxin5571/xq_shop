...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/self_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'self_express_desc';
...
class self_express
{
     ...
     * @return null
     */
    function self_express($cfg=array())
    {
     ...
     */
    function query($invoice_sn,$order_id)
    {
        $str = '<a href="user.php?act=order_detail&order_id='.$order_id.'">' .$invoice_sn. '</a>';
