...
$_LANG['label_service_repair']="申请售后";
...
$_LANG['new_password'] = '新登录密码';
$_LANG['confirm_password'] = '确认新密码';
...
$_LANG['img_name'] = '图片名称';
/* 售后*/
$_LANG['service_type']='售后类型';
$_LANG['need_service_good']="需要售后的订单商品(可多选)";
$_LANG['fault_type']="故障类型";
$_LANG['failure_phenomena']="故障现象";
$_LANG['fault_reason']='退换货理由';
$_LANG['fault_title']='故障标题';
$_LANG['noreason_topay']='无理由退换货支付';
$_LANG['service_good']='需要售后的商品为空！';
$_LANG['fault_type_null']='故障类型为空！';
$_LANG['already_processed']="此订单已提交申请，请耐心等待工作人员确认";
$_LANG['my_application']="我的申请";
$_LANG['warn_service_img']="您已经上传过图片";
$_LANG['service_update_error']='更新失败';
$_LANG['service_reply']="客服回复";
$_LANG['service_status']="售后状态";
$_LANG['service_confirm_text']="已确认申请，请等待售后人员:%s，电话：%s或%s与您电话预约上门时间";
$_LANG['service_confirm_done']='此订单售后已经完成,感谢您的支持！';
$_LANG['confirm_time_span']="回复时间";
$_LANG['welcome_to_upload_img']='为了更好的解决问题，欢迎您上传图片';
/* 留言类型 */
...
$_LANG['merge_order_notice'] = '订单合并是在发货前将相同状态的订单合并成一新的订单，收货地址，送货方式等以主定单为准。';
...
/* 登录 注册 */
$_LANG['label_username'] = '用&nbsp;&nbsp;&nbsp;户&nbsp;&nbsp;&nbsp;名';
$_LANG['label_email'] = 'email';
$_LANG['label_password'] = '设&nbsp;置&nbsp;密&nbsp;码';
$_LANG['label_confirm_password'] = '确&nbsp;认&nbsp;密&nbsp;码';
...
$_LANG['agreement'] = "我已看过并接受《<a href=\"article.php?cat_id=-1\" style=\"color:blue\" target=\"_blank\">馨清用户注册协议</a>》";
...
$_LANG['passport_js']['passwd_pwd_lower'] = "<i class='i-pwd-weak'></i>有被盗风险,建议使用字母、数字和符号两种及以上组合";
$_LANG['passport_js']['passwd_pwd_middle'] = "<i class='i-pwd-medium'></i>安全强度适中，可以使用三种以上的组合来提高安全强度";
$_LANG['passport_js']['passwd_pwd_high'] = "<i class='i-pwd-strong'></i>你的密码很安全";
$_LANG['passport_js']['captcha_notice'] = "看不清？点击图片更换验证码";
$_LANG['passport_js']['captcha_empty'] = "请输入验证码！";
...
/*微信绑定*/
$_LANG['existing_account'] ='已有馨清账号,请绑定';
$_LANG['no_account'] ='没有馨清账号,请注册';
$_LANG['weixin_bind_account'] ='微信绑定账号';
$_LANG['zfb_bind_account'] ='支付宝绑定账号';
?>