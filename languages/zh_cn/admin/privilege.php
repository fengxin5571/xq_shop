...
$_LANG['nickname'] = '管理员姓名';      
$_LANG['telephone']='管理员电话';
...
$_LANG['js_languages']['telephone_empty']='管理员电话不能为空!';
$_LANG['js_languages']['email_error'] = 'Email地址格式不正确!';
$_LANG['js_languages']['nickname_empty']="管理员姓名不能为空！";
$_LANG['js_languages']['password_error'] = '两次输入的密码不一致!';
$_LANG['js_languages']['password_empty'] = '管理员密码不能为空！';
