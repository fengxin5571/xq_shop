...
$_LANG['lab_goods_packing_list'] = '商品包装清单：';
$_LANG['format_goods_packing_list']='格式为·xxx台 ·用·分隔 ';
...
$_LANG['presell'] = '打勾表示此商品为预售商品，不用考虑库存问题，买家拍下后不会立即发货。';
