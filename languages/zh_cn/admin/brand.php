...
$_LANG['brand_desc_img'] = '品牌介绍图片';
$_LANG['brand_warrant_img'] = '品牌授权书图片';
$_LANG['brand_license_img'] = '品牌营业执照图片';
$_LANG['sort_order'] = '排序';
$_LANG['is_show'] = '是否显示';
$_LANG['drop_brand_logo'] = '删除图标';
$_LANG['confirm_drop_logo'] = '你确认要删除该图标吗？';
$_LANG['drop_brand_logo_success'] = '删除品牌logo成功';
$_LANG['drop_brand_desc_img_success'] = '删除品牌介绍图片成功';
$_LANG['drop_brand_warrant_img_success'] = '删除品牌授权书成功';
$_LANG['drop_brand_license_img_success']= '删除品牌营业执照成功';
$_LANG['brand_edit_lnk'] = '重新编辑该品牌';
$_LANG['brand_list_lnk'] = '返回列表页面';

/*帮助信息*/
$_LANG['up_brandlogo'] = '请上传图片，做为品牌的LOGO！';
$_LANG['up_branddesc'] = '请上传图片，做为品牌的介绍！建议宽度750';
$_LANG['up_brandwarrant'] = '请上传图片，做为品牌的授权！建议宽度750';
$_LANG['warn_brandlogo'] = '你已经上传过图片。再次上传时将覆盖原图片！';
$_LANG['up_brandlicense'] = '请上传图片，做为品牌的企业营业执照！建议宽度750';
/*提示信息*/
