...
$_LANG['cat_type'] = '类型';
$_LANG['cat_price'] = '价格';
$_LANG['price_span'] = '<span class="require-field">仅作为无理由退换货时使用,其他可不填！</span>';
...
$_LANG['isopen'] = '显示';
$_LANG['isclose'] = '不显示';
$_LANG['add_article'] = '添加';

$_LANG['articlecat_edit'] = '分类编辑';
...
$_LANG['not_emptycat'] = '分类下还有视频，不允许删除非空分类';

/*帮助信息*/
$_LANG['notice_keywords'] ='关键字为选填项，其目的在于方便外部搜索引擎搜索';
$_LANG['notice_isopen'] ='该分类是否显示在前台的主导航栏中。';
