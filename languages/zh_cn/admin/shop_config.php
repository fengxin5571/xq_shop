...
$_LANG['cfg_name']['is_show_presell_icn'] = '是否显示预售商品图标';
...
$_LANG['cfg_name']['is_auto_shelves'] = '是否库存为零自动下架';
$_LANG['cfg_name']['is_auto_presell'] = '是否库存为零自动成为预售商品';
...
$_LANG['cfg_range']['is_show_presell_icn']['0'] ='否';
$_LANG['cfg_range']['is_show_presell_icn']['1'] ='是';
...
$_LANG['cfg_name']['video_page_size'] = '视频分类页列表的数量';
//互亿无线代码
$_LANG['cfg_name']['ihuyi_sms_'] = '天下畅通短信设置';

$_LANG['cfg_name']['ihuyi_sms_debug'] = '调试模式';
$_LANG['cfg_desc']['ihuyi_sms_debug'] = '<font color="red"><b>如果开启调试模式将不下发短信，请求日志请查看根目录下的日志文件《sms_log_天下畅通短信平台帐号.log》</b></font>';

$_LANG['cfg_name']['ihuyi_sms_user_name'] = '天下畅通短信平台帐号';
$_LANG['cfg_name']['ihuyi_sms_user_id'] = '天下畅通短信平台企业ID';
$_LANG['cfg_desc']['ihuyi_sms_user_name'] = '请填写<a href="http://xtx.telhk.cn:8080/logins.html" target="_blank"><font color="red"><b>天下畅通短信平台</b></font></a>注册的帐号';
$_LANG['cfg_name']['ihuyi_sms_pass_word'] = '天下畅通短信平台密码';
$_LANG['cfg_desc']['ihuyi_sms_pass_word'] = '请填写<a href="http://xtx.telhk.cn:8080/logins.html" target="_blank"><font color="red"><b>天下畅通短信平台</b></font></a>帐号的密码';
$_LANG['cfg_name']['ihuyi_yy_pass_word'] = '互亿无线语音平台key';
$_LANG['cfg_desc']['ihuyi_yy_pass_word'] = '请填写<a href="http://www.ihuyi.com/product.php#reg" target="_blank"><font color="red"><b>天下畅通语音平台</b></font></a>帐号的key';
...
$_LANG['cfg_range']['is_auto_shelves']['1'] = '开启';
$_LANG['cfg_range']['is_auto_shelves']['0'] = '关闭';

$_LANG['cfg_range']['is_auto_presell']['1'] = '开启';
$_LANG['cfg_range']['is_auto_presell']['0'] = '关闭';
