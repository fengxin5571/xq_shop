...
$_LANG['user_center'] = '我的馨清';
$_LANG['shop_closed'] = '网站建设中，请您稍后再来...';
...
$_LANG['goods_free_shipping'] = '此商品为免运费商品，结算时将不计入配送费用';
$_LANG['time_promotion']="限时促销价";
...
$_LANG['goods_list'] = '全部商品';
$_LANG['fill_order'] = '填写并核对订单信息';
$_LANG['shopping_cart_modify'] = '返回修改购物车';
...
$_LANG['attr_parameter'] = '规格参数';
$_LANG['packing_list'] = '包装清单';
$_LANG['alert_sale'] = '售后保障';
$_LANG['total'] = '共';
...
$_LANG['label_regist_top'] = '免费注册';
$_LANG['label_login'] = '登录';
$_LANG['label_login_top'] = '您好，请登录';
