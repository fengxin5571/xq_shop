...
if (!defined('INIT_NO_SMARTY'))
{
    ...
    $smarty->template_dir   = ROOT_PATH . 'mobile/web1';
    ...
    $smarty->assign('ecs_css_path', './web1/themes/css/base.css');
    $smarty->assign('home_css_path','./web1/themes/css/home.css');
...
{
    echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>system_mobile</title></head><body><p align='left'>对不起,{$_CFG['shop_name']}暂时没有开启手机购物功能</p></body></html>";
    exit();
}
