 ...
 * @return  boolean
 */
function add_service_message($message) {
    ...
    " (msg_id, user_id, guzhang, goods_id, user_name, user_email, user_phone, user_company, msg_title, msg_type, msg_status,  msg_content, msg_time,service_img,order_id)".
    " VALUES (NULL, '$message[user_id]', '$message[guzhang]', '$message[goods_id]', '$message[user_name]', '$message[user_email]', ".
    " '$message[user_phone]',  '$message[user_company]', '$message[msg_title]', '$message[msg_type]', '$status', '$message[msg_content]', '".gmtime()."','$message[service_img]','$message[order_id]')";
