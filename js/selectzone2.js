...
function SelectZone()
{
  ...
  {
    Ajax.call(this.filename+"&act=" + act, 'JSON=' + objToJSONString(filters), this.loadOptionsResponse, "GET", "JSON");
  }
  ...
  this.addItem = function(all, act)
  {
    ...
    if (selOpt.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&JSON=" + objToJSONString(args) + "&add_ids=" +objToJSONString(selOpt),  objToJSONString(args), this.addRemoveItemResponse, "GET", "JSON");
    }
  }
  ...
  this.dropItem = function(all, act)
  {
    ...
    if (arr.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&JSON=" + objToJSONString(args) + "&drop_ids=" + objToJSONString(arr),  objToJSONString(args), this.addRemoveItemResponse, 'GET', 'JSON');
    }
  }
