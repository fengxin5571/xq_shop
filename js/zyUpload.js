		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
	            	...
	            	html += '						<div class="filePicker">选择您要上传的头像</div>';
		           ...
		           // html += '					<div class="webuploader_pick">继续选择</div>';
		            ...
		            html += '			</div>';
		            if(ad !=""){
		            	html += '			<div id="preview" class="upload_preview"><div id="uploadList_0" class="upload_append_list">		<a style="height:'+para.itemHeight+';width:'+para.itemWidth+'" href="#" class="imgBox">		<div class="uploadImg" style="width:'+para.itemWidth+'">			<img id="uploadImage_0" class="upload_image" src="/data/user_head/'+user_path+'/'+ad+'"style="width:'+para.itemWidth+'"  is="" too="" large="" to="" edit="">		</div>	</a>	<p id="uploadProgress_0" class="file_progress"></p>	<p id="uploadFailure_0" class="file_failure">上传失败，请重试</p>	<p id="uploadSuccess_0" class="file_success"></p></div></div>';
		            }else{
		            	html += '			<div id="preview" class="upload_preview"><div id="uploadList_0" class="upload_append_list">		<a style="height:'+para.itemHeight+';width:'+para.itemWidth+';" href="#" class="imgBox">		<div class="uploadImg" style="width:'+para.itemWidth+'">			<img id="uploadImage_0" class="upload_image" src="/themes/default/images/robot/no-img_mid_.jpg"style="width:'+para.itemWidth+'" is="" too="" large="" to="" edit="">		</div>	</a>	<p id="uploadProgress_0" class="file_progress"></p>	<p id="uploadFailure_0" class="file_failure">上传失败，请重试</p>	<p id="uploadSuccess_0" class="file_success"></p></div></div>';
		            }
