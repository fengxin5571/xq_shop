...
/*Table structure for table `rbt_account_log` */

DROP TABLE IF EXISTS `rbt_account_log`;

CREATE TABLE `rbt_account_log` (
...
/*Data for the table `rbt_ad` */

insert  into `rbt_ad`(`ad_id`,`position_id`,`media_type`,`ad_name`,`ad_link`,`ad_code`,`start_time`,`end_time`,`link_man`,`link_email`,`link_phone`,`click_count`,`enabled`) values (1,1,0,'广告一','www.163.com','1431133776216354259.jpg',1431093600,1466085600,'','','',0,1),(2,2,0,'广告二','www.126.com','1431135650065310221.jpg',1431093600,1528380000,'','','',0,1),(3,3,0,'广告三','www.111.com','1431135678742494822.jpg',1431093600,1599487200,'','','',0,1),(4,4,0,'焦点图片一','','1431255681369580481.jpg',1431180000,1560520800,'','','',2,1),(5,4,0,'焦点图片二','www.111.com','1431256341539785140.jpg',1431180000,1623420000,'','','',1,1);

/*Table structure for table `rbt_ad_custom` */

DROP TABLE IF EXISTS `rbt_ad_custom`;

CREATE TABLE `rbt_ad_custom` (
...
/*Data for the table `rbt_ad_custom` */

/*Table structure for table `rbt_ad_position` */

DROP TABLE IF EXISTS `rbt_ad_position`;

CREATE TABLE `rbt_ad_position` (
...
/*Data for the table `rbt_ad_position` */

insert  into `rbt_ad_position`(`position_id`,`position_name`,`ad_width`,`ad_height`,`position_desc`,`position_style`) values (1,'首页通栏一',1160,90,'','<table cellpadding=\"0\" cellspacing=\"0\">\r\n{foreach from=$ads item=ad}\r\n<tr><td>{$ad}</td></tr>\r\n{/foreach}\r\n</table>'),(2,'首页通栏二',1160,90,'','<table cellpadding=\"0\" cellspacing=\"0\">\r\n{foreach from=$ads item=ad}\r\n<tr><td>{$ad}</td></tr>\r\n{/foreach}\r\n</table>'),(3,'首页通栏三',1160,90,'','<table cellpadding=\"0\" cellspacing=\"0\">\r\n{foreach from=$ads item=ad}\r\n<tr><td>{$ad}</td></tr>\r\n{/foreach}\r\n</table>'),(4,'登录页面焦点',550,300,'','{foreach from=$ads item=ad}\r\n<div>{$ad}</div>\r\n{/foreach}');

/*Table structure for table `rbt_admin_action` */

DROP TABLE IF EXISTS `rbt_admin_action`;

CREATE TABLE `rbt_admin_action` (
...
/*Data for the table `rbt_admin_message` */

/*Table structure for table `rbt_admin_user` */

DROP TABLE IF EXISTS `rbt_admin_user`;

CREATE TABLE `rbt_admin_user` (
...
/*Data for the table `rbt_admin_user` */

insert  into `rbt_admin_user`(`user_id`,`user_name`,`email`,`password`,`add_time`,`last_login`,`last_ip`,`action_list`,`nav_list`,`lang_type`,`agency_id`,`suppliers_id`,`todolist`,`role_id`) values (1,'admin','scbadu@163.com','cedb4cda86af950197d275007c6c44c6',1430430653,1433243958,'0.0.0.0','all','商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,商店设置|shop_config.php?act=list_edit','',0,0,NULL,NULL),(2,'bjgonghuo1','bj@163.com','d0c015b6eb9a280f318a4c0510581e7e',1245044099,0,'','','商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,商店设置|shop_config.php?act=list_edit','',0,1,'',NULL),(3,'shhaigonghuo1','shanghai@163.com','4146fecce77907d264f6bd873f4ea27b',1245044202,0,'','','商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,商店设置|shop_config.php?act=list_edit','',0,2,'',NULL);

/*Table structure for table `rbt_adsense` */

DROP TABLE IF EXISTS `rbt_adsense`;

CREATE TABLE `rbt_adsense` (
...
/*Data for the table `rbt_adsense` */

insert  into `rbt_adsense`(`from_ad`,`referer`,`clicks`) values (4,'本站',2),(5,'本站',1);

/*Table structure for table `rbt_affiliate_log` */

DROP TABLE IF EXISTS `rbt_affiliate_log`;

CREATE TABLE `rbt_affiliate_log` (
...
/*Data for the table `rbt_affiliate_log` */

/*Table structure for table `rbt_agency` */

DROP TABLE IF EXISTS `rbt_agency`;

CREATE TABLE `rbt_agency` (
...
/*Data for the table `rbt_agency` */

/*Table structure for table `rbt_area_region` */

DROP TABLE IF EXISTS `rbt_area_region`;

CREATE TABLE `rbt_area_region` (
  `shipping_area_id` smallint(5) unsigned NOT NULL DEFAULT '0',
  `region_id` smallint(5) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`shipping_area_id`,`region_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `rbt_area_region` */

insert  into `rbt_area_region`(`shipping_area_id`,`region_id`) values (1,1),(2,1),(3,1),(4,3),(4,4),(4,6),(4,9),(4,30),(4,32);

/*Table structure for table `rbt_article` */

DROP TABLE IF EXISTS `rbt_article`;

CREATE TABLE `rbt_article` (
...
/*Data for the table `rbt_article_cat` */

insert  into `rbt_article_cat`(`cat_id`,`cat_name`,`cat_type`,`keywords`,`cat_desc`,`sort_order`,`show_in_nav`,`parent_id`) values (1,'系统分类',2,'','系统保留分类',50,0,0),(2,'网店信息',3,'','网店信息分类',50,0,1),(3,'网店帮助分类',4,'','网店帮助分类',50,0,1),(5,'新手上路 ',5,'','',50,0,3),(6,'手机常识 ',5,'','手机常识 ',50,0,3),(7,'配送与支付 ',5,'','配送与支付 ',50,0,3),(8,'服务保证 ',5,'','',50,0,3),(9,'联系我们 ',5,'','联系我们 ',50,0,3),(10,'会员中心',5,'','',50,0,3),(12,'商城公告',1,'','',50,0,0);

/*Table structure for table `rbt_attribute` */

DROP TABLE IF EXISTS `rbt_attribute`;

CREATE TABLE `rbt_attribute` (
...
/*Data for the table `rbt_attribute` */

/*Table structure for table `rbt_auction_log` */

DROP TABLE IF EXISTS `rbt_auction_log`;

CREATE TABLE `rbt_auction_log` (
  `log_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rbt_auction_log` */

insert  into `rbt_auction_log`(`log_id`,`act_id`,`bid_user`,`bid_price`,`bid_time`) values (1,4,1,'170.00',1242144083);

/*Table structure for table `rbt_auto_manage` */

DROP TABLE IF EXISTS `rbt_auto_manage`;

CREATE TABLE `rbt_auto_manage` (
...
/*Data for the table `rbt_auto_manage` */

/*Table structure for table `rbt_back_goods` */

DROP TABLE IF EXISTS `rbt_back_goods`;

CREATE TABLE `rbt_back_goods` (
...
/*Data for the table `rbt_back_goods` */

/*Table structure for table `rbt_back_order` */

DROP TABLE IF EXISTS `rbt_back_order`;

CREATE TABLE `rbt_back_order` (
...
/*Data for the table `rbt_bonus_type` */

insert  into `rbt_bonus_type`(`type_id`,`type_name`,`type_money`,`send_type`,`min_amount`,`max_amount`,`send_start_date`,`send_end_date`,`use_start_date`,`use_end_date`,`min_goods_amount`) values (1,'用户红包','2.00',0,'0.00','0.00',1242057600,1244736000,1242057600,1250006400,'500.00'),(2,'商品红包','10.00',1,'0.00','0.00',1241971200,1250352000,1242057600,1250006400,'500.00'),(3,'订单红包','20.00',2,'1500.00','0.00',1242057600,1309363200,1242057600,1257955200,'800.00'),(4,'线下红包','5.00',3,'0.00','0.00',1242057600,1244736000,1242057600,1255449600,'360.00');

/*Table structure for table `rbt_booking_goods` */

DROP TABLE IF EXISTS `rbt_booking_goods`;

CREATE TABLE `rbt_booking_goods` (
  `rec_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rbt_booking_goods` */

insert  into `rbt_booking_goods`(`rec_id`,`user_id`,`email`,`link_man`,`tel`,`goods_id`,`goods_desc`,`goods_number`,`booking_time`,`is_dispose`,`dispose_user`,`dispose_time`,`dispose_note`) values (1,1,'ecshop@ecshop.com','刘先生','13986765412',19,'可以补货吗？\n我想要一个',1,1242142762,0,'',0,''),(2,3,'text@ecshop.com','叶先生','13588104710',17,'什么时候有货',1,1242143592,0,'',0,'');

/*Table structure for table `rbt_brand` */

DROP TABLE IF EXISTS `rbt_brand`;

CREATE TABLE `rbt_brand` (
...
/*Data for the table `rbt_card` */

insert  into `rbt_card`(`card_id`,`card_name`,`card_img`,`card_fee`,`free_money`,`card_desc`) values (1,'祝福贺卡','1242108754847457261.jpg','5.00','1000.00','把您的祝福带给您身边的人');

/*Table structure for table `rbt_cart` */

DROP TABLE IF EXISTS `rbt_cart`;

CREATE TABLE `rbt_cart` (
  `rec_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_cart` */

/*Table structure for table `rbt_cat_recommend` */

DROP TABLE IF EXISTS `rbt_cat_recommend`;

CREATE TABLE `rbt_cat_recommend` (
  `cat_id` smallint(5) NOT NULL,
  `recommend_type` tinyint(1) NOT NULL,
  PRIMARY KEY (`cat_id`,`recommend_type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `rbt_cat_recommend` */

insert  into `rbt_cat_recommend`(`cat_id`,`recommend_type`) values (3,1),(3,2),(3,3),(5,1),(5,2),(5,3),(12,1),(12,2),(12,3),(13,3),(14,2),(14,3),(15,1),(15,2);

/*Table structure for table `rbt_category` */

DROP TABLE IF EXISTS `rbt_category`;

CREATE TABLE `rbt_category` (
...
/*Data for the table `rbt_category` */

insert  into `rbt_category`(`cat_id`,`cat_name`,`keywords`,`cat_desc`,`parent_id`,`sort_order`,`template_file`,`measure_unit`,`show_in_nav`,`style`,`is_show`,`grade`,`filter_attr`) values (1,'工业机器人','','',0,1,'','',0,'',1,5,''),(2,'SCARA机器人','','',1,50,'','',0,'',1,0,''),(3,'直角坐标机器人','','',1,50,'','台',0,'',1,4,''),(4,'多关节机器人','','',1,50,'','',0,'',1,0,''),(5,'并联机器人','','',1,50,'','',0,'',1,5,''),(6,'洁净机器人','','',0,2,'','',0,'',1,0,''),(7,'大气机械手','','',6,50,'','',0,'',1,0,''),(17,'送餐机器人','','',16,50,'','',0,'',1,0,''),(11,'真空机械手','','',6,50,'','',0,'',1,0,''),(12,'移动机器人','','',0,3,'','',0,'',1,0,''),(13,'装配型','','',12,50,'','',0,'',1,0,''),(14,'搬运型','','',12,50,'','',0,'',1,0,''),(16,'智能服务机器人','','',0,4,'','',0,'',1,0,''),(18,'教育机器人','','',16,50,'','',0,'',1,0,''),(19,'陪护机器人','','',16,50,'','',0,'',1,0,''),(20,'家用机器人','','',16,50,'','',0,'',1,0,''),(21,'探测救援机器人','','',16,50,'','',0,'',1,0,''),(22,'展示机器人','','',16,50,'','',0,'',1,0,''),(23,'乐高机器人玩具','','',16,50,'','',0,'',1,0,''),(24,'擦玻璃机器人','','',16,50,'','',0,'',1,0,''),(25,'扫地机器人','','',16,50,'','',0,'',1,0,''),(26,'特种机器人','','',0,5,'','',0,'',1,0,''),(27,'物流装备','','',26,50,'','',0,'',1,0,''),(28,'能源装备','','',26,50,'','',0,'',1,0,''),(29,'纳米制版打印机','','',26,50,'','',0,'',1,0,''),(30,'上下料机器人','','',26,50,'','',0,'',1,0,''),(31,'激光3D打印','','',26,50,'','',0,'',1,0,''),(32,'桁架机械手','','',26,50,'','',0,'',1,0,''),(33,'机器人零部件','','',0,6,'','',0,'',1,0,''),(34,'零部件加工','','',33,50,'','',0,'',1,0,''),(35,'伺服电机','','',33,50,'','',0,'',1,0,''),(36,'伺服驱动器','','',33,50,'','',0,'',1,0,''),(37,'软件','','',33,50,'','',0,'',1,0,''),(38,'控制器','','',33,50,'','',0,'',1,0,''),(39,'减速器','','',33,50,'','',0,'',1,0,''),(40,'其他','','',0,7,'','',0,'',1,0,''),(41,'智慧DIY','','',40,50,'','',0,'',1,0,''),(42,'数字化智能车间','','',40,50,'','',0,'',1,0,'');

/*Table structure for table `rbt_collect_goods` */

DROP TABLE IF EXISTS `rbt_collect_goods`;

CREATE TABLE `rbt_collect_goods` (
  `rec_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_collect_goods` */

/*Table structure for table `rbt_comment` */

DROP TABLE IF EXISTS `rbt_comment`;
...
/*Data for the table `rbt_comment` */

insert  into `rbt_comment`(`comment_id`,`comment_type`,`id_value`,`email`,`user_name`,`content`,`comment_rank`,`add_time`,`ip_address`,`status`,`parent_id`,`user_id`) values (1,0,12,'ecshop@ecshop.com','ecshop','很好，我很喜欢',5,1242107120,'0.0.0.0',1,0,1),(2,0,22,'ecshop@ecshop.com','ecshop','这个我不是很适合我',5,1242107295,'0.0.0.0',0,0,1),(3,0,19,'scbadu@163.com','','sasdasda',4,1432679967,'0.0.0.0',0,0,0),(4,0,19,'scbadu@163.com','','sdssdfsd',5,1432680424,'0.0.0.0',1,0,0),(5,0,19,'scbadu@163.com','admin','dgdgdfg',0,1432680472,'0.0.0.0',0,4,0);

/*Table structure for table `rbt_crons` */

DROP TABLE IF EXISTS `rbt_crons`;

CREATE TABLE `rbt_crons` (
...
/*Data for the table `rbt_crons` */

/*Table structure for table `rbt_delivery_goods` */

DROP TABLE IF EXISTS `rbt_delivery_goods`;

CREATE TABLE `rbt_delivery_goods` (
  `rec_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rbt_delivery_goods` */

insert  into `rbt_delivery_goods`(`rec_id`,`delivery_id`,`goods_id`,`product_id`,`product_sn`,`goods_name`,`brand_name`,`goods_sn`,`is_real`,`extension_code`,`parent_id`,`send_number`,`goods_attr`) values (1,1,13,0,NULL,'诺基亚5320 XpressMusic','诺基亚','ECS000013',1,'',0,3,NULL),(2,1,14,0,NULL,'诺基亚5800XM','诺基亚','ECS000014',1,'',0,1,NULL),(3,2,24,0,NULL,'P806','联想','ECS000024',1,'',0,3,NULL),(4,2,9,0,NULL,'诺基亚E66','诺基亚','ECS000009',1,'',0,1,NULL),(5,3,24,0,NULL,'P806','联想','ECS000024',1,'',0,1,NULL),(6,3,8,0,NULL,'飞利浦9@9v','飞利浦','ECS000008',1,'',0,3,NULL),(7,4,12,0,NULL,'摩托罗拉A810','摩托罗拉','ECS000012',1,'',0,2,NULL),(8,5,24,0,NULL,'P806','联想','ECS000024',1,'',0,1,NULL);

/*Table structure for table `rbt_delivery_order` */

DROP TABLE IF EXISTS `rbt_delivery_order`;

CREATE TABLE `rbt_delivery_order` (
...
/*Data for the table `rbt_email_list` */

/*Table structure for table `rbt_email_sendlist` */

DROP TABLE IF EXISTS `rbt_email_sendlist`;

CREATE TABLE `rbt_email_sendlist` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rbt_email_sendlist` */

/*Table structure for table `rbt_error_log` */

DROP TABLE IF EXISTS `rbt_error_log`;

CREATE TABLE `rbt_error_log` (
...
/*Data for the table `rbt_error_log` */

/*Table structure for table `rbt_exchange_goods` */

DROP TABLE IF EXISTS `rbt_exchange_goods`;

CREATE TABLE `rbt_exchange_goods` (
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_exchange_goods` */

insert  into `rbt_exchange_goods`(`goods_id`,`exchange_integral`,`is_exchange`,`is_hot`) values (24,17000,1,0),(19,80000,1,0);

/*Table structure for table `rbt_favourable_activity` */

DROP TABLE IF EXISTS `rbt_favourable_activity`;

CREATE TABLE `rbt_favourable_activity` (
...
/*Data for the table `rbt_favourable_activity` */

insert  into `rbt_favourable_activity`(`act_id`,`act_name`,`start_time`,`end_time`,`user_rank`,`act_range`,`act_range_ext`,`min_amount`,`max_amount`,`act_type`,`act_type_ext`,`gift`,`sort_order`) values (1,'5.1诺基亚优惠活动',1241107200,1253030400,'1,2',2,'1','500.00','5000.00',2,'95.00','a:0:{}',50);

/*Table structure for table `rbt_feedback` */

DROP TABLE IF EXISTS `rbt_feedback`;

CREATE TABLE `rbt_feedback` (
...
/*Data for the table `rbt_feedback` */

insert  into `rbt_feedback`(`msg_id`,`parent_id`,`user_id`,`user_name`,`user_email`,`msg_title`,`msg_type`,`msg_status`,`msg_content`,`msg_time`,`message_img`,`order_id`,`msg_area`) values (1,0,1,'ecshop','ecshop@ecshop.com','三星SGH-F258什么时候到',4,0,'三星SGH-F258什么时候有货',1242107197,'',0,0);

/*Table structure for table `rbt_friend_link` */

DROP TABLE IF EXISTS `rbt_friend_link`;

CREATE TABLE `rbt_friend_link` (
...
/*Data for the table `rbt_friend_link` */

insert  into `rbt_friend_link`(`link_id`,`link_name`,`link_url`,`link_logo`,`show_order`) values (3,'诺博泰智能科技','http://www.robots-cn.com/','',1);

/*Table structure for table `rbt_goods` */

DROP TABLE IF EXISTS `rbt_goods`;

CREATE TABLE `rbt_goods` (
...
/*Data for the table `rbt_goods_article` */

insert  into `rbt_goods_article`(`goods_id`,`article_id`,`admin_id`) values (1,27,1),(7,40,0),(8,28,0),(9,8,1),(13,29,0),(14,29,0),(14,31,0),(23,8,1),(23,30,0),(23,31,0),(32,8,1),(32,30,0);

/*Table structure for table `rbt_goods_attr` */

DROP TABLE IF EXISTS `rbt_goods_attr`;

CREATE TABLE `rbt_goods_attr` (
...
/*Data for the table `rbt_goods_attr` */

/*Table structure for table `rbt_goods_cat` */

DROP TABLE IF EXISTS `rbt_goods_cat`;

CREATE TABLE `rbt_goods_cat` (
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `cat_id` smallint(5) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`goods_id`,`cat_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `rbt_goods_cat` */

insert  into `rbt_goods_cat`(`goods_id`,`cat_id`) values (8,2),(8,5),(16,3),(16,5);

/*Table structure for table `rbt_goods_gallery` */

DROP TABLE IF EXISTS `rbt_goods_gallery`;

CREATE TABLE `rbt_goods_gallery` (
...
/*Data for the table `rbt_goods_type` */

/*Table structure for table `rbt_goods_video` */

DROP TABLE IF EXISTS `rbt_goods_video`;

CREATE TABLE `rbt_goods_video` (
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `video_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `admin_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`goods_id`,`video_id`,`admin_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `rbt_goods_video` */

insert  into `rbt_goods_video`(`goods_id`,`video_id`,`admin_id`) values (21,43,0),(25,43,0);

/*Table structure for table `rbt_group_goods` */

DROP TABLE IF EXISTS `rbt_group_goods`;

CREATE TABLE `rbt_group_goods` (
  `parent_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_group_goods` */

insert  into `rbt_group_goods`(`parent_id`,`goods_id`,`goods_price`,`admin_id`) values (9,4,'58.00',1),(9,3,'68.00',1),(9,7,'100.00',1),(14,5,'20.00',1),(14,6,'42.00',1),(14,7,'100.00',1);

/*Table structure for table `rbt_keywords` */

DROP TABLE IF EXISTS `rbt_keywords`;

CREATE TABLE `rbt_keywords` (
...
/*Data for the table `rbt_keywords` */

insert  into `rbt_keywords`(`date`,`searchengine`,`keyword`,`count`) values ('2009-04-21','ecshop','诺基亚',1),('2009-04-27','ecshop','智能手机',1),('2009-05-04','ecshop','斤',1),('2009-05-10','ecshop','诺基亚',1),('2009-05-11','ecshop','智能手机',1),('2009-05-11','ecshop','诺基亚',1),('2009-05-12','ecshop','三星',1),('2009-05-12','ecshop','智能手机',1),('2009-05-12','ecshop','p806',1),('2009-05-12','ecshop','诺基亚',1),('2009-05-12','ecshop','夏新',1),('2009-05-18','ecshop','52',2),('2009-05-22','ecshop','p',1),('2015-05-04','ecshop','ddd',2),('2015-05-04','ecshop','机器人驱动',1),('2015-05-04','ecshop','机器人',3),('2015-05-04','ecshop','夏新',1),('2015-05-05','ecshop','sss',5),('2015-05-06','ecshop','k',3),('2015-05-10','ecshop','机器人',1),('2015-05-16','ecshop','事实上',1),('2015-05-19','ecshop','智能车间',1),('2015-05-22','ecshop','d\\\'d',1),('2015-05-22','ecshop','夏新N7',1),('2015-05-22','ecshop','夏新',1),('2015-05-22','ecshop','夏',1),('2015-05-22','ecshop','dd',1),('2015-05-22','ecshop','诺基亚',56),('2015-05-22','ecshop','培训视频',4);

/*Table structure for table `rbt_link_goods` */

DROP TABLE IF EXISTS `rbt_link_goods`;

CREATE TABLE `rbt_link_goods` (
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_link_goods` */

insert  into `rbt_link_goods`(`goods_id`,`link_goods_id`,`is_double`,`admin_id`) values (12,9,0,1),(12,10,0,1),(12,11,0,1),(9,13,1,1),(13,9,1,1),(14,9,0,1),(14,13,0,1),(23,9,0,1),(13,23,1,1),(23,13,1,1);

/*Table structure for table `rbt_mail_templates` */

DROP TABLE IF EXISTS `rbt_mail_templates`;

CREATE TABLE `rbt_mail_templates` (
...
/*Data for the table `rbt_member_price` */

insert  into `rbt_member_price`(`price_id`,`goods_id`,`user_rank`,`user_price`) values (1,23,3,'3200.00'),(2,23,2,'3300.00'),(3,13,3,'1100.00'),(4,13,2,'1200.00');

/*Table structure for table `rbt_nav` */

DROP TABLE IF EXISTS `rbt_nav`;

CREATE TABLE `rbt_nav` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rbt_nav` */

insert  into `rbt_nav`(`id`,`ctype`,`cid`,`name`,`ifshow`,`vieworder`,`opennew`,`url`,`type`) values (2,'',0,'帮助中心',1,2,0,'article.php?id=39','top'),(3,'',0,'网站导航',1,0,0,'article.php?id=3','top'),(38,NULL,NULL,'欢迎合作',1,4,0,'article.php?id=37','bottom'),(37,NULL,NULL,'诚征英才',1,3,0,'article.php?id=36','bottom'),(36,'',0,'联系我们',1,2,0,'article.php?id=4','bottom'),(35,'',0,'联盟介绍',1,1,0,'article.php?id=5','bottom'),(28,NULL,NULL,'首页',1,1,0,'index.php','middle'),(29,NULL,NULL,'机器人商城',1,2,0,'index.php','middle'),(30,NULL,NULL,'6S售后服务',1,3,0,'index.php','middle'),(34,NULL,NULL,'每日打折',1,7,0,'index.php','middle'),(31,NULL,NULL,'人才输送',1,4,0,'index.php','middle'),(32,'',0,'技术支持',1,5,0,'index.php','middle'),(33,'',0,'影音库',1,6,0,'video_cat.php','middle'),(39,NULL,NULL,'法律声明',1,5,0,'article.php?id=38','bottom'),(40,NULL,NULL,'服务条款',1,6,0,'article.php?id=1','bottom'),(41,NULL,NULL,'隐私声明',1,7,0,'article.php?id=2','bottom'),(42,NULL,NULL,'网站导航',1,8,0,'article.php?id=3','bottom');

/*Table structure for table `rbt_order_action` */

DROP TABLE IF EXISTS `rbt_order_action`;

CREATE TABLE `rbt_order_action` (
...
/*Data for the table `rbt_order_action` */

/*Table structure for table `rbt_order_goods` */

DROP TABLE IF EXISTS `rbt_order_goods`;

CREATE TABLE `rbt_order_goods` (
  `rec_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `goods_name` varchar(120) NOT NULL DEFAULT '',
...
/*Data for the table `rbt_order_goods` */

/*Table structure for table `rbt_order_info` */

DROP TABLE IF EXISTS `rbt_order_info`;

CREATE TABLE `rbt_order_info` (
...
/*Data for the table `rbt_order_info` */

/*Table structure for table `rbt_pack` */

DROP TABLE IF EXISTS `rbt_pack`;

CREATE TABLE `rbt_pack` (
...
/*Data for the table `rbt_pack` */

insert  into `rbt_pack`(`pack_id`,`pack_name`,`pack_img`,`pack_fee`,`free_money`,`pack_desc`) values (1,'精品包装','1242108360911825791.jpg','5.00',800,'精品包装，尽心为您设计一份不一样的礼物');

/*Table structure for table `rbt_package_goods` */

DROP TABLE IF EXISTS `rbt_package_goods`;

CREATE TABLE `rbt_package_goods` (
...
/*Data for the table `rbt_package_goods` */

insert  into `rbt_package_goods`(`package_id`,`goods_id`,`product_id`,`goods_number`,`admin_id`) values (5,6,0,1,1),(5,5,0,1,1),(6,4,0,1,1),(6,7,0,1,1),(6,32,0,1,1),(5,31,0,1,1);

/*Table structure for table `rbt_pay_log` */

DROP TABLE IF EXISTS `rbt_pay_log`;

CREATE TABLE `rbt_pay_log` (
  `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_pay_log` */

insert  into `rbt_pay_log`(`log_id`,`order_id`,`order_amount`,`order_type`,`is_paid`) values (1,1,'0.00',0,0),(2,2,'0.00',0,0),(3,3,'0.00',0,0),(4,4,'0.00',0,0),(5,5,'0.00',0,0),(6,6,'35.00',0,0),(7,7,'2198.10',0,0),(8,8,'638.00',0,0),(9,9,'2015.00',0,0),(10,10,'0.00',0,0),(11,11,'3810.00',0,0),(12,12,'253.00',0,0),(13,13,'975.00',0,0),(14,14,'0.00',0,0),(15,15,'17054.00',0,0),(16,16,'0.00',0,0),(17,17,'0.00',0,0),(18,18,'0.00',0,0),(19,20,'2085.00',0,0),(20,21,'14815.00',0,0),(21,22,'2210.00',0,0);

/*Table structure for table `rbt_payment` */

DROP TABLE IF EXISTS `rbt_payment`;

CREATE TABLE `rbt_payment` (
...
/*Data for the table `rbt_payment` */

insert  into `rbt_payment`(`pay_id`,`pay_code`,`pay_name`,`pay_fee`,`pay_desc`,`pay_order`,`pay_config`,`enabled`,`is_cod`,`is_online`) values (1,'balance','余额支付','0','使用帐户余额支付。只有会员才能使用，通过设置信用额度，可以透支。',0,'a:0:{}',1,0,1),(2,'bank','银行汇款/转帐','0','银行名称\n收款人信息：全称 ××× ；帐号或地址 ××× ；开户行 ×××。\n注意事项：办理电汇时，请在电汇单“汇款用途”一栏处注明您的订单号。',0,'a:0:{}',1,0,0),(3,'cod','货到付款','0','开通城市：×××\n货到付款区域：×××',0,'a:0:{}',1,1,0);

/*Table structure for table `rbt_plugins` */

DROP TABLE IF EXISTS `rbt_plugins`;

CREATE TABLE `rbt_plugins` (
...
/*Data for the table `rbt_plugins` */

/*Table structure for table `rbt_products` */

DROP TABLE IF EXISTS `rbt_products`;

CREATE TABLE `rbt_products` (
...
/*Data for the table `rbt_products` */

insert  into `rbt_products`(`product_id`,`goods_id`,`goods_attr`,`product_sn`,`product_number`) values (1,32,'163','',100),(2,24,'167','',100),(3,23,'175','',100),(4,21,'188','',20),(5,20,'194','',13),(6,17,'201','',1),(7,14,'213','',4),(8,13,'217','',8),(9,10,'239','',6),(10,10,'240','',12),(11,9,'227','',12),(12,9,'226','',3),(13,8,'231','',17),(14,1,'237','',1);

/*Table structure for table `rbt_reg_extend_info` */

DROP TABLE IF EXISTS `rbt_reg_extend_info`;

CREATE TABLE `rbt_reg_extend_info` (
...
/*Data for the table `rbt_reg_extend_info` */

/*Table structure for table `rbt_reg_fields` */

DROP TABLE IF EXISTS `rbt_reg_fields`;

CREATE TABLE `rbt_reg_fields` (
...
/*Data for the table `rbt_reg_fields` */

insert  into `rbt_reg_fields`(`id`,`reg_field_name`,`dis_order`,`display`,`type`,`is_need`) values (1,'MSN',0,1,1,1),(2,'QQ',0,1,1,1),(3,'办公电话',0,1,1,1),(4,'家庭电话',0,1,1,1),(5,'手机',0,1,1,1),(6,'密码找回问题',0,1,1,1);

/*Table structure for table `rbt_region` */

DROP TABLE IF EXISTS `rbt_region`;

CREATE TABLE `rbt_region` (
...
/*Data for the table `rbt_role` */

/*Table structure for table `rbt_searchengine` */

DROP TABLE IF EXISTS `rbt_searchengine`;

CREATE TABLE `rbt_searchengine` (
  `date` date NOT NULL DEFAULT '0000-00-00',
  `searchengine` varchar(20) NOT NULL DEFAULT '',
  `count` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_searchengine` */

/*Table structure for table `rbt_sessions` */

DROP TABLE IF EXISTS `rbt_sessions`;

CREATE TABLE `rbt_sessions` (
...
/*Data for the table `rbt_sessions` */

/*Table structure for table `rbt_sessions_data` */

DROP TABLE IF EXISTS `rbt_sessions_data`;

CREATE TABLE `rbt_sessions_data` (
...
/*Data for the table `rbt_sessions_data` */

/*Table structure for table `rbt_shipping` */

DROP TABLE IF EXISTS `rbt_shipping`;

CREATE TABLE `rbt_shipping` (
...
/*Data for the table `rbt_shipping` */

insert  into `rbt_shipping`(`shipping_id`,`shipping_code`,`shipping_name`,`shipping_desc`,`insure`,`support_cod`,`enabled`,`shipping_print`,`print_bg`,`config_lable`,`print_model`) values (1,'post_express','邮政快递包裹','邮政快递包裹的描述内容。','1%',0,1,'',NULL,NULL,0),(2,'yto','圆通速递','上海圆通物流（速递）有限公司经过多年的网络快速发展，在中国速递行业中一直处于领先地位。为了能更好的发展国际快件市场，加快与国际市场的接轨，强化圆通的整体实力，圆通已在东南亚、欧美、中东、北美洲、非洲等许多城市运作国际快件业务','0',1,1,'',NULL,NULL,0),(3,'city_express','城际快递','配送的运费是固定的','0',1,1,'',NULL,NULL,0),(4,'flat','市内快递','固定运费的配送方式内容','0',1,1,'',NULL,NULL,0),(5,'sto_express','申通快递','江、浙、沪地区首重为15元/KG，其他地区18元/KG， 续重均为5-6元/KG， 云南地区为8元','0',0,1,'',NULL,NULL,0),(6,'post_mail','邮局平邮','邮局平邮的描述内容。','0',0,1,'',NULL,NULL,0),(7,'fpd','运费到付','所购商品到达即付运费','0',0,1,'',NULL,NULL,0);

/*Table structure for table `rbt_shipping_area` */

DROP TABLE IF EXISTS `rbt_shipping_area`;

CREATE TABLE `rbt_shipping_area` (
...
/*Data for the table `rbt_snatch_log` */

insert  into `rbt_snatch_log`(`log_id`,`snatch_id`,`user_id`,`bid_price`,`bid_time`) values (1,2,1,'17.00',1242142910),(2,1,1,'50.00',1242142935);

/*Table structure for table `rbt_stats` */
...
/*Data for the table `rbt_stats` */

insert  into `rbt_stats`(`access_time`,`ip_address`,`visit_times`,`browser`,`system`,`language`,`area`,`referer_domain`,`referer_path`,`access_url`) values (1240294063,'0.0.0.0',196,'FireFox 3.0.8','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1240298833,'0.0.0.0',198,'FireFox 3.0.8','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1240380013,'0.0.0.0',204,'FireFox 3.0.8','Windows XP','zh-cn','IANA','http://localhost:8080','/','/shoujitiyan/index.php'),(1240463462,'0.0.0.0',208,'FireFox 3.0.9','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1240800901,'0.0.0.0',222,'FireFox 3.0.9','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1240803254,'0.0.0.0',227,'FireFox 3.0.9','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1240904381,'0.0.0.0',237,'FireFox 3.0.9','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1241419322,'0.0.0.0',250,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/goods.php?act=list','/shoujitiyan/goods.php'),(1241420999,'0.0.0.0',252,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1241424831,'0.0.0.0',253,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/goods.php?act=list','/shoujitiyan/goods.php'),(1241498580,'0.0.0.0',257,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1241511324,'0.0.0.0',262,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/goods.php?act=list','/shoujitiyan/goods.php'),(1241514671,'0.0.0.0',263,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1241517726,'0.0.0.0',265,'FireFox 3.0.10','Windows XP','zh-cn','IANA','','','/shoujitiyan/index.php'),(1241946350,'127.0.0.1',39,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1241965138,'127.0.0.1',41,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/','/shoujitiyan/index.php'),(1241966751,'127.0.0.1',43,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1241970153,'127.0.0.1',45,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/goods.php?act=list','/shoujitiyan/goods.php'),(1241970640,'127.0.0.1',47,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1242105962,'0.0.0.0',310,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/goods.php?act=list','/shoujitiyan/goods.php'),(1242140915,'127.0.0.1',52,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1242141002,'127.0.0.1',54,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/user.php','/shoujitiyan/user.php'),(1242141352,'127.0.0.1',57,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/user.php?act=address_list','/shoujitiyan/user.php'),(1242141605,'127.0.0.1',59,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/user.php','/shoujitiyan/user.php'),(1242576210,'127.0.0.1',72,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1242576982,'127.0.0.1',74,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/article.php?act=list&uselastfilter=1','/shoujitiyan/article.php'),(1242577205,'127.0.0.1',76,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/article.php?act=list','/shoujitiyan/article.php'),(1242579230,'127.0.0.1',78,'FireFox 2.0.0.20','Windows XP','zh-cn','LAN','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1242973907,'0.0.0.0',375,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1242974337,'0.0.0.0',377,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/','/shoujitiyan/search.php'),(1242976474,'0.0.0.0',379,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1244189098,'0.0.0.0',418,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1244191271,'0.0.0.0',420,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/index.php','/shoujitiyan/article.php'),(1244191479,'0.0.0.0',422,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1244193068,'0.0.0.0',426,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/article.php?id=33','/shoujitiyan/index.php'),(1244772987,'0.0.0.0',466,'FireFox 3.0.10','Windows XP','zh-cn','IANA','http://localhost:8080','/shoujitiyan/admin/index.php?act=top','/shoujitiyan/index.php'),(1245042503,'0.0.0.0',472,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/privilege.php?act=login','/shouji/index.php'),(1245042507,'0.0.0.0',472,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/index.php?act=top','/shouji/index.php'),(1245046089,'0.0.0.0',474,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/index.php?act=top','/shouji/index.php'),(1245047906,'0.0.0.0',476,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/goods.php?id=24','/shouji/user.php'),(1245047951,'0.0.0.0',478,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/group_buy.php?act=view&id=8','/shouji/goods.php'),(1245048514,'0.0.0.0',480,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/flow.php?step=checkout','/shouji/index.php'),(1245139613,'0.0.0.0',488,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/index.php?act=top','/shouji/index.php'),(1245140082,'0.0.0.0',490,'FireFox 3.0.11','Windows XP','zh-cn','IANA','','','/shouji/article.php'),(1245145064,'0.0.0.0',493,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/index.php?act=top','/shouji/index.php'),(1245217308,'0.0.0.0',498,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/','/shouji/index.php'),(1245219380,'0.0.0.0',499,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/index.php?act=top','/shouji/index.php'),(1245222219,'0.0.0.0',500,'FireFox 3.0.11','Windows XP','zh-cn','IANA','http://localhost:8080','/shouji/admin/goods.php?act=list','/shouji/goods.php'),(1430430675,'0.0.0.0',8,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/install/index.php?lang=zh_cn&step=done','/index.php'),(1430430924,'0.0.0.0',9,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430480410,'0.0.0.0',10,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430485042,'0.0.0.0',12,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/index.php'),(1430742870,'0.0.0.0',13,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430743652,'0.0.0.0',15,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430819019,'0.0.0.0',16,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430828006,'0.0.0.0',17,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430828981,'0.0.0.0',19,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430829310,'0.0.0.0',21,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/index.php'),(1430829767,'0.0.0.0',23,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/index.php'),(1430860769,'0.0.0.0',24,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430861391,'0.0.0.0',26,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/search.php?encode=YToyOntzOjg6ImtleXdvcmRzIjtzOjE6ImsiO3M6MTg6InNlYXJjaF9lbmNvZGVfdGltZSI7aToxNDMwODY4MTE2O30=','/index.php'),(1430863132,'0.0.0.0',28,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/index.php'),(1430947882,'0.0.0.0',29,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430950442,'0.0.0.0',31,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430950685,'0.0.0.0',33,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430952097,'0.0.0.0',35,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430995584,'0.0.0.0',36,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430995585,'0.0.0.0',36,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1430998610,'0.0.0.0',38,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431000662,'0.0.0.0',40,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/article_cat.php?id=12','/index.php'),(1431034029,'0.0.0.0',42,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431118242,'0.0.0.0',43,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431120486,'0.0.0.0',45,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431124763,'0.0.0.0',47,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/admin/goods.php?act=list','/goods.php'),(1431130730,'0.0.0.0',49,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431133360,'0.0.0.0',51,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/index.php'),(1431134317,'0.0.0.0',53,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431135512,'0.0.0.0',55,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431136206,'0.0.0.0',57,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431136230,'0.0.0.0',59,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431136512,'0.0.0.0',61,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431160680,'0.0.0.0',62,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431161013,'0.0.0.0',64,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/article_cat.php'),(1431164541,'0.0.0.0',65,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/article.php'),(1431169204,'0.0.0.0',67,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/article_cat.php'),(1431171009,'0.0.0.0',69,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/article_cat.php'),(1431243795,'0.0.0.0',70,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431244174,'0.0.0.0',72,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=2','/user.php'),(1431245594,'0.0.0.0',74,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php','/user.php'),(1431252392,'0.0.0.0',75,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php','/user.php'),(1431257818,'0.0.0.0',77,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php','/user.php'),(1431294149,'0.0.0.0',78,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431294149,'0.0.0.0',78,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431295384,'0.0.0.0',80,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=register','/user.php'),(1431335329,'0.0.0.0',81,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431349734,'0.0.0.0',82,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431379305,'0.0.0.0',83,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431429451,'0.0.0.0',84,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431467406,'0.0.0.0',85,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431553639,'0.0.0.0',86,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431600548,'0.0.0.0',87,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431682052,'0.0.0.0',88,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431727095,'0.0.0.0',89,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431729681,'0.0.0.0',90,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/search.php?encode=YToyOntzOjg6ImtleXdvcmRzIjtzOjk6IuS6i%2bWunuS4iiI7czoxODoic2VhcmNoX2VuY29kZV90aW1lIjtpOjE0MzE3MzQzMDM7fQ==','/index.php'),(1431734833,'0.0.0.0',91,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431737778,'0.0.0.0',92,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/video_cat.php'),(1431737936,'0.0.0.0',93,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431744871,'0.0.0.0',94,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431749447,'0.0.0.0',95,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431749447,'0.0.0.0',95,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431751456,'0.0.0.0',96,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/video_cat.php'),(1431769110,'0.0.0.0',97,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431777125,'0.0.0.0',98,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/video_cat.php','/video_cat.php'),(1431780246,'0.0.0.0',99,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/video_cat.php','/video_cat.php'),(1431985847,'0.0.0.0',100,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1431987574,'0.0.0.0',101,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432025131,'0.0.0.0',102,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432025908,'0.0.0.0',104,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/category.php'),(1432028841,'0.0.0.0',106,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/category.php'),(1432031173,'0.0.0.0',108,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=7','/category.php'),(1432033149,'0.0.0.0',110,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/category.php'),(1432035538,'0.0.0.0',112,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/category.php'),(1432120245,'0.0.0.0',113,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432120305,'0.0.0.0',115,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=2','/index.php'),(1432121006,'0.0.0.0',117,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/category.php'),(1432123699,'0.0.0.0',119,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=1&price_min=5000&price_max=6200&filter_attr=164.0.186','/category.php'),(1432123997,'0.0.0.0',121,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=1&price_min=5000&price_max=6200&filter_attr=164.0.186','/category.php'),(1432125641,'0.0.0.0',123,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC','/category.php'),(1432245864,'0.0.0.0',124,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432290553,'0.0.0.0',125,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432292983,'0.0.0.0',127,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/category.php'),(1432294068,'0.0.0.0',129,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/search.php?encode=YToyOntzOjg6ImtleXdvcmRzIjtzOjk6IuivuuWfuuS6miI7czoxODoic2VhcmNoX2VuY29kZV90aW1lIjtpOjE0MzIzMDA0MDk7fQ==','/search.php'),(1432553731,'0.0.0.0',131,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432554894,'0.0.0.0',133,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC','/goods.php'),(1432558396,'0.0.0.0',134,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC','/goods.php'),(1432559245,'0.0.0.0',136,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC','/goods.php'),(1432560737,'0.0.0.0',138,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=2','/goods.php'),(1432590478,'0.0.0.0',139,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432636047,'0.0.0.0',140,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432636566,'0.0.0.0',142,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=17','/index.php'),(1432639587,'0.0.0.0',143,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432640797,'0.0.0.0',145,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/goods.php'),(1432643202,'0.0.0.0',146,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/goods.php'),(1432676548,'0.0.0.0',147,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432677671,'0.0.0.0',149,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/goods.php'),(1432678333,'0.0.0.0',151,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/','/goods.php'),(1432679520,'0.0.0.0',153,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=19','/captcha.php'),(1432728081,'0.0.0.0',154,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432728317,'0.0.0.0',156,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/admin/order.php?act=info&order_id=1','/goods.php'),(1432729764,'0.0.0.0',158,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/goods.php'),(1432731066,'0.0.0.0',160,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/goods.php'),(1432731461,'0.0.0.0',162,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/goods.php'),(1432734097,'0.0.0.0',164,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/goods.php'),(1432734415,'0.0.0.0',166,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/goods.php'),(1432764114,'0.0.0.0',167,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432764599,'0.0.0.0',169,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=13','/goods.php'),(1432765222,'0.0.0.0',171,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=20','/goods.php'),(1432765557,'0.0.0.0',173,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=20','/goods.php'),(1432765626,'0.0.0.0',175,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=16','/goods.php'),(1432766810,'0.0.0.0',177,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/category.php?id=1&price_min=0&price_max=0&filter_attr=0.163.0','/goods.php'),(1432766943,'0.0.0.0',178,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432964346,'0.0.0.0',179,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1432966869,'0.0.0.0',181,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/index.php','/goods.php'),(1432968690,'0.0.0.0',183,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=19','/flow.php'),(1432975870,'0.0.0.0',184,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=cart','/flow.php'),(1433032498,'0.0.0.0',185,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1433034604,'0.0.0.0',187,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=consignee','/flow.php'),(1433037906,'0.0.0.0',188,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=consignee','/flow.php'),(1433038047,'0.0.0.0',190,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=21','/goods.php'),(1433038047,'0.0.0.0',190,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=21','/goods.php'),(1433039915,'0.0.0.0',191,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=login','/flow.php'),(1433039936,'0.0.0.0',192,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=login','/flow.php'),(1433039948,'0.0.0.0',193,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=login','/flow.php'),(1433039983,'0.0.0.0',194,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php?step=login','/flow.php'),(1433042686,'0.0.0.0',195,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php','/flow.php'),(1433042827,'0.0.0.0',196,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/flow.php','/flow.php'),(1433045133,'0.0.0.0',197,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=logout','/index.php'),(1433070631,'0.0.0.0',198,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1433071039,'0.0.0.0',200,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php','/user.php'),(1433071065,'0.0.0.0',202,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php','/captcha.php'),(1433071066,'0.0.0.0',202,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php','/user.php'),(1433154731,'0.0.0.0',203,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php'),(1433154921,'0.0.0.0',205,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=order_list','/user.php'),(1433161746,'0.0.0.0',207,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=collection_list','/user.php'),(1433162556,'0.0.0.0',209,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=profile','/user.php'),(1433162946,'0.0.0.0',211,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/goods.php?id=9','/user.php'),(1433164315,'0.0.0.0',212,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=logout','/flow.php'),(1433164315,'0.0.0.0',212,'Safari 537.36','Windows NT','zh-CN,zh','IANA','http://localhost','/user.php?act=logout','/category.php'),(1433243756,'0.0.0.0',213,'Safari 537.36','Windows NT','zh-CN,zh','IANA','','','/index.php');

/*Table structure for table `rbt_suppliers` */

DROP TABLE IF EXISTS `rbt_suppliers`;

CREATE TABLE `rbt_suppliers` (
...
/*Data for the table `rbt_suppliers` */

insert  into `rbt_suppliers`(`suppliers_id`,`suppliers_name`,`suppliers_desc`,`is_check`) values (1,'北京供货商','北京供货商',1),(2,'上海供货商','上海供货商',1);

/*Table structure for table `rbt_tag` */

DROP TABLE IF EXISTS `rbt_tag`;

CREATE TABLE `rbt_tag` (
...
/*Data for the table `rbt_tag` */

insert  into `rbt_tag`(`tag_id`,`user_id`,`goods_id`,`tag_words`) values (1,0,13,'音乐手机'),(2,0,14,'音乐手机'),(3,0,23,'音乐手机'),(4,0,23,'智能手机'),(5,0,14,'智能手机'),(6,0,22,'智能手机'),(7,0,31,'音乐手机');

/*Table structure for table `rbt_template` */

DROP TABLE IF EXISTS `rbt_template`;

CREATE TABLE `rbt_template` (
...
/*Data for the table `rbt_template` */

/*Table structure for table `rbt_topic` */

DROP TABLE IF EXISTS `rbt_topic`;

CREATE TABLE `rbt_topic` (
...
/*Data for the table `rbt_topic` */

insert  into `rbt_topic`(`topic_id`,`title`,`intro`,`start_time`,`end_time`,`data`,`template`,`css`,`topic_img`,`title_pic`,`base_style`,`htmls`,`keywords`,`description`) values (1,'夏新优惠大酬宾','<p>夏新产品优惠开始了</p>',1241107200,1246291200,'O:8:\"stdClass\":1:{s:7:\"default\";a:1:{i:0;s:11:\"夏新N7|17\";}}','','',NULL,NULL,NULL,NULL,NULL,NULL);

/*Table structure for table `rbt_user_account` */

DROP TABLE IF EXISTS `rbt_user_account`;

CREATE TABLE `rbt_user_account` (
...
/*Data for the table `rbt_user_account` */

/*Table structure for table `rbt_user_address` */

DROP TABLE IF EXISTS `rbt_user_address`;

CREATE TABLE `rbt_user_address` (
...
/*Data for the table `rbt_user_address` */

insert  into `rbt_user_address`(`address_id`,`address_name`,`user_id`,`consignee`,`email`,`country`,`province`,`city`,`district`,`address`,`zipcode`,`tel`,`mobile`,`sign_building`,`best_time`) values (1,'',1,'刘先生','ecshop@ecshop.com',1,2,52,502,'海兴大厦','','010-25851234','13986765412','',''),(2,'',3,'叶先生','text@ecshop.com',1,2,52,510,'通州区旗舰凯旋小区','','13588104710','','',''),(3,'',6,'赖昀','scbadu@163.com',1,8,112,975,'hhhhhhhh','','028-84120000','','','');

/*Table structure for table `rbt_user_bonus` */

DROP TABLE IF EXISTS `rbt_user_bonus`;

CREATE TABLE `rbt_user_bonus` (
...
/*Data for the table `rbt_user_bonus` */

insert  into `rbt_user_bonus`(`bonus_id`,`bonus_type_id`,`bonus_sn`,`user_id`,`used_time`,`order_id`,`emailed`) values (1,3,0,1,1242142681,4,0),(2,4,1000003379,1,1242976699,14,0),(3,4,1000018450,0,0,0,0),(4,4,1000023774,0,0,0,0),(5,4,1000039394,0,0,0,0),(6,4,1000049305,0,0,0,0),(7,4,1000052248,0,0,0,0),(8,4,1000061542,0,0,0,0),(9,4,1000070278,0,0,0,0),(10,4,1000080588,0,0,0,0),(11,4,1000091405,0,0,0,0),(27,3,0,1,0,0,0),(28,3,0,1,0,0,0),(29,3,0,1,0,0,0),(30,3,0,1,0,0,0),(31,3,0,1,0,0,0);

/*Table structure for table `rbt_user_feed` */

DROP TABLE IF EXISTS `rbt_user_feed`;

CREATE TABLE `rbt_user_feed` (
...
/*Data for the table `rbt_user_feed` */

/*Table structure for table `rbt_user_rank` */

DROP TABLE IF EXISTS `rbt_user_rank`;

CREATE TABLE `rbt_user_rank` (
...
/*Data for the table `rbt_user_rank` */

insert  into `rbt_user_rank`(`rank_id`,`rank_name`,`min_points`,`max_points`,`discount`,`show_price`,`special_rank`) values (1,'注册用户',0,10000,100,1,0),(2,'vip',10000,10000000,95,1,0),(3,'代销用户',0,0,90,0,1);

/*Table structure for table `rbt_users` */

DROP TABLE IF EXISTS `rbt_users`;

CREATE TABLE `rbt_users` (
...
/*Data for the table `rbt_users` */

insert  into `rbt_users`(`user_id`,`email`,`user_name`,`password`,`question`,`answer`,`sex`,`birthday`,`user_money`,`frozen_money`,`pay_points`,`rank_points`,`address_id`,`reg_time`,`last_login`,`last_time`,`last_ip`,`visit_count`,`user_rank`,`is_special`,`salt`,`parent_id`,`flag`,`alias`,`msn`,`qq`,`office_phone`,`home_phone`,`mobile_phone`,`is_validated`,`credit_line`,`passwd_question`,`passwd_answer`) values (1,'ecshop@ecshop.com','ecshop','554fcae493e564ee0dc75bdf2ebf94ca','','',0,'1960-03-03','5577.70','0.00',92821,9823,1,0,1245048540,'0000-00-00 00:00:00','0.0.0.0',11,0,0,'0',0,0,'','','','','','',0,'0.00',NULL,NULL),(2,'vip@ecshop.com','vip','232059cb5361a9336ccf1b8c2ba7657a','','',0,'1949-01-01','0.00','0.00',0,0,0,0,0,'0000-00-00 00:00:00','',0,0,0,'0',0,0,'','','','','','',0,'0.00',NULL,NULL),(3,'text@ecshop.com','text','1cb251ec0d568de6a929b520c4aed8d1','','',0,'1949-01-01','1000.00','0.00',0,0,2,0,1242973574,'0000-00-00 00:00:00','0.0.0.0',2,0,0,'0',0,0,'','','','','','',0,'0.00',NULL,NULL),(5,'zuanshi@ecshop.com','zuanshi','815a71fb334412e7ba4595741c5a111d','','',0,'1949-01-01','0.00','10000.00',0,0,0,0,0,'0000-00-00 00:00:00','',0,3,0,'0',0,0,'','','','','','',0,'0.00',NULL,NULL),(6,'scbadu@163.com','laiyun','87b305b5c1dd724108c3f9977d811c91','','',0,'0000-00-00','0.00','0.00',0,0,3,1432976408,1433243783,'0000-00-00 00:00:00','0.0.0.0',130,0,0,'0',0,0,'','','','','','',0,'0.00',NULL,NULL);

/*Table structure for table `rbt_video` */

DROP TABLE IF EXISTS `rbt_video`;

CREATE TABLE `rbt_video` (
  ...
  `author_email` varchar(60) NOT NULL DEFAULT '',
  `keywords` varchar(255) NOT NULL DEFAULT '',
  `video_type` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `is_open` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `add_time` int(10) unsigned NOT NULL DEFAULT '0',
  `file_url` varchar(255) NOT NULL DEFAULT '',
  `open_type` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
/*Data for the table `rbt_video` */

insert  into `rbt_video`(`video_id`,`cat_id`,`title`,`content`,`author`,`author_email`,`keywords`,`video_type`,`is_open`,`add_time`,`file_url`,`open_type`,`link`,`description`,`video_img`) values (40,15,'测试视频一','<p>&nbsp;sdfsfsddddddddddddddddddddddddddddddddddd</p>','赖昀','scbadu@163.com','ddfdf',2,1,1431469790,'data/video/1431770824799605171.flv',2,'','sdfsdfsdfsd','data/video/1431756802262034497.jpg'),(41,15,'测试视频二','','sss','','',2,1,1431555646,'',0,'','laiyunlaiyun','data/video/1431755543547625233.jpg'),(42,16,'爱人同志1114444444444444','<p>&nbsp;yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy</p>','sss','scbadu@163.com','yyy',1,1,1431555705,'',0,'<embed src=\"http://player.youku.com/player.php/Type/Folder/Fid/23794004/Ob/1/sid/XOTU2NjQxMzky/v.swf\" quality=\"high\" width=\"480\" height=\"400\" align=\"middle\" allowScriptAccess=\"always\" allowFullScreen=\"true\" mode=\"transparent\" type=\"application/x-shockwave-flash\"></embed>','sssssssssppp','data/video/1431751438096805760.jpg');

/*Table structure for table `rbt_video_cat` */

DROP TABLE IF EXISTS `rbt_video_cat`;

CREATE TABLE `rbt_video_cat` (
  `cat_id` smallint(5) NOT NULL AUTO_INCREMENT,
  `cat_name` varchar(255) NOT NULL DEFAULT '',
  `keywords` varchar(255) NOT NULL DEFAULT '',
  `cat_desc` varchar(255) NOT NULL DEFAULT '',
...
/*Data for the table `rbt_video_cat` */

insert  into `rbt_video_cat`(`cat_id`,`cat_name`,`keywords`,`cat_desc`,`sort_order`,`parent_id`,`cat_img`) values (16,'培训视频','培训视频','培训视频',1,0,'data/videocat/1431777051281558392.jpg'),(15,'企业宣传2','企业宣传视频','企业宣传视频',2,0,'data/videocat/1431777000466167428.jpg'),(17,'产品视频','产品视频','产品视频',50,0,'data/videocat/1431776582928335125.jpg');

/*Table structure for table `rbt_virtual_card` */

DROP TABLE IF EXISTS `rbt_virtual_card`;

CREATE TABLE `rbt_virtual_card` (
...
/*Data for the table `rbt_volume_price` */

insert  into `rbt_volume_price`(`price_type`,`goods_id`,`volume_number`,`volume_price`) values (1,1,5,'1366.00'),(1,9,3,'2200.00'),(1,9,5,'2100.00'),(1,13,5,'1150.00'),(1,13,3,'1200.00');

/*Table structure for table `rbt_vote` */

DROP TABLE IF EXISTS `rbt_vote`;

CREATE TABLE `rbt_vote` (
...
/*Data for the table `rbt_vote` */

insert  into `rbt_vote`(`vote_id`,`vote_name`,`start_time`,`end_time`,`can_multi`,`vote_count`) values (1,'您从哪里知道我们的网站',1213200000,1274803200,0,0);

/*Table structure for table `rbt_vote_log` */

DROP TABLE IF EXISTS `rbt_vote_log`;

CREATE TABLE `rbt_vote_log` (
  `log_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `rbt_vote_log` */

/*Table structure for table `rbt_vote_option` */

DROP TABLE IF EXISTS `rbt_vote_option`;

CREATE TABLE `rbt_vote_option` (
...
/*Data for the table `rbt_vote_option` */

insert  into `rbt_vote_option`(`option_id`,`vote_id`,`option_name`,`option_count`,`option_order`) values (1,1,'论坛',0,100),(2,1,'朋友',0,100),(3,1,'友情链接',0,100);

/*Table structure for table `rbt_wholesale` */

DROP TABLE IF EXISTS `rbt_wholesale`;

CREATE TABLE `rbt_wholesale` (
  `act_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` mediumint(8) unsigned NOT NULL,
  `goods_name` varchar(255) NOT NULL,
...
/*Data for the table `rbt_wholesale` */

insert  into `rbt_wholesale`(`act_id`,`goods_id`,`goods_name`,`rank_ids`,`prices`,`enabled`) values (1,21,'金立 A30','1,2','a:1:{i:0;a:2:{s:4:\"attr\";a:1:{i:120;s:1:\"0\";}s:7:\"qp_list\";a:2:{i:0;a:2:{s:8:\"quantity\";i:50;s:5:\"price\";d:1700;}i:1;a:2:{s:8:\"quantity\";i:100;s:5:\"price\";d:1680;}}}}',1);
