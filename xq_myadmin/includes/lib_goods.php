...
function goods_list($is_delete, $real_goods=1, $conditions = '')
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT g.goods_id, g.goods_name, g.goods_type, g.goods_sn, g.shop_price, g.is_on_sale, g.is_best, g.is_new, g.is_hot, g.sort_order, g.goods_number, g.integral,g.is_presell,a.attr_value AS xinhao, " .
                    ...
                    " ON(g.goods_id= a.goods_id AND a.attr_id=210) ".
