...
$modules['17_video']['video_cat']                   = 'video_cat.php?act=list';
$modules['17_video']['video_list']                  = 'video.php?act=list';

/*
$modules['18_technology']['hangye']                 = 'technology.php?&type=hangye&act=list';
$modules['18_technology']['gongneng']               = 'technology.php?&type=gongneng&act=list';
$modules['18_technology']['request']                = 'technology_form.php?act=list_all';
*/
$modules['19_service']['service']                   = 'service.php?act=list';
$modules['19_service']['service_repair']            = 'service_repair.php?act=list_all';
$modules['19_service']['noreason_payment']          = 'noreason_payment.php?act=list';
//$modules['19_service']['service_keep']              = 'service_keep.php?act=list_all';
/*
$modules['20_talent']['talent_cat']                 = 'talent_cat.php?act=list';
$modules['20_talent']['talent']             		= 'talent.php?act=list';
$modules['20_talent']['talent_request']             = 'talent_request.php?act=list_all';
*/
...
$modules['08_members']['11_user_update']            = 'user_update.php?act=list';
