...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    $smarty->assign('cat_list_all',get_categories_tree());
    $smarty->assign('brand_list', get_brand_list());
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $is_presell=  isset($_POST['is_presell']) ? 1 : 0;
    ...
    $catgory_id = empty($_POST['cat_id']) ? empty($_POST['other_cat'])?0:$_POST['other_cat'][0] : intval($_POST['cat_id']);
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "promote_start_date, promote_end_date, goods_img, goods_thumb, original_img, keywords, goods_brief,goods_packing_list, " .
                    "seller_note, goods_weight, goods_number, warn_number, integral, give_integral, is_best, is_new, is_hot, " .
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id,is_presell)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]','$_POST[goods_packing_list]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id','$is_presell')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral,is_presell)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[goods_packing_list]','$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral','$is_presell')";
        }
    }
    else
    {
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
                ...
                "goods_packing_list='$_POST[goods_packing_list]',".
...
//-- 修改是否为预售商品
/*------------------------------------------------------ */
elseif ($_REQUEST['act'] == 'edit_is_is_presell')
{
    check_authz_json('goods_manage');

    $goods_id   = intval($_POST['id']);
    $is_presell = json_str_iconv(trim($_POST['val']));

    if ($exc->edit("is_presell = '$is_presell' ,last_update=" .gmtime()." ,goods_number=0", $goods_id))
    {
        clear_cache_files();
        make_json_result(stripslashes($is_presell));
    }
}
/*------------------------------------------------------ */
//-- 修改商品货号
...
elseif ($_REQUEST['act'] == 'edit_goods_number')
{
    ...
    $goods = $db->getRow($sql);
    if($goods['is_presell']){
        make_json_error("此商品为预售商品！库存不能修改");
    }
...
elseif ($_REQUEST['act'] == 'edit_goods_img')
{
    ...
    {
       make_json_error("商品主图为空！");
    }
    $goods = $json->decode($_POST['goods']);
    if($exc->edit("goods_thumb= '$goods->goods_thumb', goods_img= '$goods->img_url', original_img='$goods->img_original'", $goods->goods_id)){
        clear_cache_files();
        make_json_result("设置商品主图成功！");
    }else{
        make_json_error("设置商品主图失败！");
    }
}
