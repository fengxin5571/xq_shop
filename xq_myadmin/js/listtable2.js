 ...
 * 创建一个可编辑区
 */
listTable.edit = function(obj, act, id, type)
{
  ...
  txt.onblur = function(e)
  {
    ...
    {
      res = Ajax.call(listTable.url, "type=" + type + "&act="+act+"&val=" + encodeURIComponent(Utils.trim(txt.value)) + "&id=" +id, null, "POST", "JSON", false);
...
listTable.remove = function(id, cfm, opt, type)
{
  ...
  if (confirm(cfm))
  {
    var args = "type=" + type + "&act=" + opt + "&id=" + id + this.compileFilter();
